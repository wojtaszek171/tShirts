...
public class ModelTargetTrainedRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        if (updateGuideViewTexture)
        {
            if (currentModelTarget != null && !currentModelTarget.getGuideViews().empty())
            {
                ...
                activeGuideView = currentModelTarget.getGuideView(activeGuideViewIndex);
                ...
                if (activeGuideView != null && activeGuideView.getImage() != null)
                {
                    ...
                    updateGuideViewTexture(textureImage);
                }
            }
        }
    ...
    private void updateGuideViewTexture(Image textureImage)
    {
